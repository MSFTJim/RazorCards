...
public class IndexModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        Cocktails.Add(new Cocktail() { Id = 1001, Name = "Grasshopper", Price = 15.25M, ImagePath = "https://127.0.0.1:7116/images/grasshopper.jpg" });        
        Cocktails.Add(new Cocktail() { Id = 1002, Name = "Manhattan", Price = 15.25M, ImagePath = "https://127.0.0.1:7116/images/manhattan.jpg" });
        Cocktails.Add(new Cocktail() { Id = 1003, Name = "Martini", Price = 15.25M, ImagePath = "https://127.0.0.1:7116/images/martini.jpg" });            
        Cocktails.Add(new Cocktail() { Id = 1004, Name = "Beer", Price = 15.25M, ImagePath = "https://127.0.0.1:7116/images/NoImage.jpg" });
